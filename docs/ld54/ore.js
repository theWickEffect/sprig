...
export async function initOre(spacePath) {
    ...
    onCollides([OreCarrierDef], [OreStoreDef], [LD54GameStateDef], (carrier, store, res) => {
        // must be carrying
    ...
    onCollides([OreCarrierDef, SpaceSuitDef], [OreDef, PositionDef, RenderableDef, AngularVelocityDef], [], (carrier, ore) => {
