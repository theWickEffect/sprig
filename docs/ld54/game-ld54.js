...
import { AllEndesga16 } from "../color/palettes.js";
...
export async function initLD54() {
    EM.addEagerInit([], [RendererDef, GraphicsSettingsDef], [], (res) => {
        ...
        res.graphicsSettings.onGraphicsChange.push((useHighGraphics) => setRenderPipelines(useHighGraphics));
