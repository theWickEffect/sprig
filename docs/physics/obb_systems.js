...
EM.addSystem("updateOBBFromLocalAABB", Phase.GAME_WORLD, [OBBDef, WorldFrameDef, ColliderDef], [], (es) => {
    for (let e of es) {
        if (!isAABBCollider(e.collider)) {
            dbgLogOnce(`ent ${e.id} has OBBDef and ColliderDef but not an AABBCollider!`, undefined, true);
            continue;
        }
...
//# sourceMappingURL=obb_systems.js.map