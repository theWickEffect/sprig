...
import { CY, comparisonSamplerPtr, nearestSamplerPtr, } from "../gpu-registry.js";
...
import { RenderableDef, RendererWorldFrameDef, RendererDef, } from "../renderer-ecs.js";
import { sceneBufPtr, mainDepthTex, computeVertsData, VertexStruct, surfacesTexturePtr, canvasTexturePtr, } from "./std-scene.js";
...
export const PainterlyUniDef = EM.defineNonupdatableComponent("painterlyUni", (r) => PainterlyUniStruct.fromPartial(r));
// TODO(@darzu): PERF. could probably save perf by using custom vertex data
export const painterlyLineMeshPoolPtr = CY.createMeshPool("painterlyLineMeshPool", {
    computeVertsData,
...
// TODO(@darzu): PERF. could probably save perf by using custom vertex data
export const painterlyPointMeshPoolPtr = CY.createMeshPool("painterlyPointMeshPool", {
    computeVertsData,
    vertsStruct: VertexStruct,
    unisStruct: PainterlyUniStruct,
    maxMeshes: MAX_MESHES,
...
export const painterlyLinePrepass = CY.createRenderPipeline("painterlyLinePrepass", {
    globals: [sceneBufPtr],
    cullMode: "none",
    shaderVertexEntry: "vert_main",
    shaderFragmentEntry: "frag_main",
...
export const painterlyPointPrepass = CY.createRenderPipeline("painterlyPointPrepass", {
...
export const painterlyLineMainPass = CY.createRenderPipeline("painterlyLineMainPipe", {
    ...painterlyMainPass,
    meshOpt: {
        pool: painterlyLineMeshPoolPtr,
        stepMode: "per-mesh-handle",
...
export const painterlyPointMainPass = CY.createRenderPipeline("painterlyPointMainPipe", {
    ...painterlyMainPass,
    meshOpt: {
        pool: painterlyPointMeshPoolPtr,
        stepMode: "per-mesh-handle",
...
EM.addEagerInit([PainterlyUniDef], [], [], () => {
    EM.addSystem("updatePainterlyUni", Phase.RENDER_PRE_DRAW, [RenderableDef, PainterlyUniDef, RendererWorldFrameDef], [RendererDef], (objs, res) => {
        for (let o of objs) {
...
export const painterlyDeferredPipe = CY.createRenderPipeline("painterlyDeferredPipe", {
    globals: [
...
//# sourceMappingURL=std-painterly.js.map