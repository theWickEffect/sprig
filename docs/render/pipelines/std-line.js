...
import { sceneBufPtr, mainDepthTex, litTexturePtr, computeVertsData, VertexStruct, } from "./std-scene.js";
...
export const LineUniDef = EM.defineNonupdatableComponent("lineUni", (r) => LineUniStruct.fromPartial(r));
...
EM.addEagerInit([LineUniDef], [], [], () => {
    EM.addSystem("updateLineUni", Phase.RENDER_PRE_DRAW, [RenderableDef, LineUniDef, RendererWorldFrameDef], [RendererDef], (objs, res) => {
        for (let o of objs) {
...
//# sourceMappingURL=std-line.js.map