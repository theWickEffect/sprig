...
export const pipeDbgInitParticles = CY.createComputePipeline("pipeDbgInitParticles", {
...
export const pipeParticleRender = CY.createRenderPipeline("pipeParticleRender", {
    globals: [sceneBufPtr],
    meshOpt: {
...
export const pipeParticleUpdate = CY.createComputePipeline("pipeParticleUpdate", {
    shaderComputeEntry: "main",
    shader: (shaders) => `const numParticles: u32 = ${maxNumParticles};
${shaders["std-rand"].code}
...
//# sourceMappingURL=std-particle.js.map