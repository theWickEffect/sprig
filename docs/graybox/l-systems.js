...
import { V, V3, mat4 } from "../matrix/sprig-matrix.js";
import { PositionDef, ScaleDef } from "../physics/transform.js";
import { DEFAULT_MASK, PAINTERLY_JFA_PRE_PASS_MASK, } from "../render/pipeline-masks.js";
import { PainterlyUniDef, painterlyLineMeshPoolPtr, painterlyPointMeshPoolPtr, } from "../render/pipelines/std-painterly.js";
...
export function testingLSys() {
    ...
    const pointSurfs = [];
    const maxStack = 10;
    let _cursors = range(maxStack).map((_) => mat4.create());
    let _cursorIdx = 0;
    ...
    const mov = (x, y, z) => mat4.translate(cursor, [x, y, z], cursor);
    const push = () => {
...
//# sourceMappingURL=l-systems.js.map