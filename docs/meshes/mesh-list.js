...
import { mkCubeMesh, SHIP_OFFSET, makePlaneMesh, TETRA_MESH, mkOctogonMesh, mkHalfEdgeQuadMesh, HEX_MESH, RAFT_MESH, BULLET_MESH, GRID_PLANE_MESH, DBG_FABRIC, TRI_FENCE, makeSailMesh, mkTimberSplinterEnd, createRudderMesh, mkArrowMesh, } from "./primatives.js";
...
export const CannonLD51Mesh = XY.registerMesh({
    ...
    transformBasis: transformYUpModelIntoZUp,
    transform: mat4.fromRotationTranslationScale(quat.rotX(quat.IDENTITY, Math.PI * -0.5, quat.mk()), [0, 0, 0], 
