...
EM.addLazyInit([], [TextDef], () => {
    const upperDiv = (document.getElementById("title-div") ?? undefined);
    const debugDiv = (document.getElementById("debug-div") ?? undefined);
    const lowerDiv = (document.getElementById("lower-div") ?? undefined);
    const helpDiv = (document.getElementById("help-div") ?? undefined);
