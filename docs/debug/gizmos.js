...
export function createGizmoMesh() {
    const mesh = mergeMeshes(createLineMesh(0.1, [0.05, 0, 0], [1, 0, 0]), createLineMesh(0.1, [0, 0.05, 0], [0, 1, 0]), createLineMesh(0.1, [0, 0, 0.05], [0, 0, 1], [1, 0, 0]));
